...
for year in years:
    ...
    nml['ddf_config']['ClimateSource'] = projects + '/Projects/DSC-Snow/input_data_hourly/met_inp_Nevis_nztm250m_{}.nc'.format(year)
    nml['ddf_config']['OutputFile'] = projects + '/Projects/DSC-Snow/runs/output/nevis_2D_test_erebus/Nevis_nztm250m_{}_test24.nc'.format(year)
    nml['ddf_config']['starttime'][0] = year
    nml['ddf_config']['endtime'][0] = year + 1
    # write namelist
    path_to_output_namelist = projects + '/Projects/DSC-Snow/runs/input/nevis_2D_test_erebus/ddf_config_{}_test24.txt'.format(year)
