...
config['tf'] = 0.1 * 24  # hamish 0.13. ruschle 0.04, pelliciotti 0.05
...
inp_swe = aws_df.swe[start_t:end_t] * 1000  # measured swe - convert to mm w.e.
...
plt.plot(plot_dt, inp_swe, label='obs')
...
plt.savefig('C:/Users/conwayjp/OneDrive - NIWA/projects/SIN_density_SIP/tuning_dsc_snow/Mueller TF{:2.3f}RF{:2.4f}Tmelt{:3.2f}_ros{}.png'.format(config['tf'],
                                                                                                                                                 config['rf'],
                                                                                                                                                 config[
                                                                                                                                                     'tmelt'],
                                                                                                                                                 config['ros']))
