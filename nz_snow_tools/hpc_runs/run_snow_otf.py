...
def run_snow_otf_main(hydro_years_to_take, run_id, met_inp, which_model, catchment, output_dem, mask_dem, mask_folder, dem_folder, output_folder, data_folder,
                      precip_infile, tmax_infile, tmin_infile, solar_rad_infile, config):
...
if __name__ == '__main__':
    ...
    precip_infile = '/nesi/nobackup/niwa00026/VCSN/Rain/rain_vclim_clidb_1972010100_2020080200_south-island_p05_daily_netcdf4.nc'
    tmax_infile = '/nesi/nobackup/niwa00026/VCSN/TMax_Norton/tmax_vclim_clidb_Norton_1972010100_2020080200_south-island_p05_daily_netcdf4.nc'
    tmin_infile = '/nesi/nobackup/niwa00026/VCSN/TMin_Norton/tmin_vclim_clidb_Norton_1972010100_2020080200_south-island_p05_daily_netcdf4.nc'
    solar_rad_infile = '/nesi/nobackup/niwa00026/VCSN/SRad/srad_vclim_clidb_1972010100_2020080200_south-island_p05_daily_netcdf4.nc'
    ...
    run_snow_otf_main(hydro_years_to_take, run_id, met_inp, which_model, catchment, output_dem, mask_dem, mask_folder, dem_folder, output_folder, data_folder,
                      precip_infile, tmax_infile, tmin_infile, solar_rad_infile, config)
