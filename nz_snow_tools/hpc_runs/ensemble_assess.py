...
dict_in = pkl.load(open(r'C:\Users\conwayjp\OneDrive - NIWA\projects\CARH2201\snow_model_ensembles\FSM2_output\collated_output_test1.pkl', 'rb'))
...
for i, run_id in enumerate(dict_in.keys()):
    ...
    assert np.all(sim_swe.index == obs_swe.index)
...
plt.tight_layout()
fig.savefig(outfolder + "/Mod_vs_Meas_line_optimised_test1.png", format="png", )
# # compute daily melt
# daily_swe3 = []
# obs_swe_daily = []
