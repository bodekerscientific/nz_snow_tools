...
if __name__ == '__main__':
    ...
    ax.set_ylim([0, 8e4])
    # plt.grid(True)
    plt.savefig(plot_folder + '/SCA model {}_{}_{}_{}_{}_{}_{}_thres{}_smoothed{}.png'.format(hydro_years_to_take[0], hydro_years_to_take[-1], met_inp, which_model, catchment,
    ...
    ax.set_ylim([0,15])
    # plt.grid(True)
    plt.savefig(plot_folder + '/SWE model {}_{}_{}_{}_{}_{}_{}_thres{}_smoothed{}.png'.format(hydro_years_to_take[0], hydro_years_to_take[-1], met_inp, which_model, catchment,
                                                                                   output_dem, run_id, model_swe_sc_threshold,smooth_period), dpi=600)
